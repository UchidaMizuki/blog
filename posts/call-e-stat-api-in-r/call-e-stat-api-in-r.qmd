...
ただし，現状では，取得したデータ`data_sleeptime_2015` に多くの列が存在するため，分析しづらくなっています．**ステップα**で，データ取得とデータ整形を同時に行う方法について説明します．
...
最後に，取得したデ男女・年齢階級別の睡眠時間（2015年）をグラフ化してみましょう．グラフより，男性と女性では年齢階級別の睡眠時間の傾向が異なることがわかります．
