...
ここでは，年齢階級別のデータが格納された`"who_longer_byage"` フォルダをデータセットのサンプルとして用いましょう．
...
また，最近では，地理データを扱えるsfパッケージのデータをparquetとして保存できる[sfarrow](https://github.com/wcjochem/sfarrow)なども登場しています．
