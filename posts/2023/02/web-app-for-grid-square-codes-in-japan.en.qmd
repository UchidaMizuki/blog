...
It retrieves grid squares by municipality from the [List of grid square codes by municipality](List of grid square codes by municipality "https://www.stat.go.jp/data/mesh/m_itiran.html") published by the Statistics Bureau of Japan.
...
The jpgrid package provides grid square data by municipality via the `grid_city` dataset.
...
The jpgrid package used to build this app provides many other features not included in the app. For details, please see [here](here "https://uchidamizuki.github.io/jpgrid/").
